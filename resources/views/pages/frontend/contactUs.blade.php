            ...
            <div class="grid grid-cols-1 lg:grid-cols-3 md:grid-cols-2
                ...
                <div class="px-6 mt-6 text-center">
                    ...
                    <div class="content mt-7">
                        ...
                        <p class="mt-3 text-slate-400">The phrasal sequence
                            of the is now so that many campaign and benefit</p>
                        <div class="mt-5">
                ...
                <div class="px-6 mt-6 text-center">
                    ...
                    <div class="content mt-7">
                        ...
                        <p class="mt-3 text-slate-400">C/54 Northwest
                            Freeway, Suite 558, <br> Houston, USA 485</p>
                        <div class="mt-5">
        ...
        <div class="container mt-16 md:mt-24">
            <div class="grid md:grid-cols-12 grid-cols-1 items-center
                ...
                <div class="mt-8 lg:col-span-5 md:col-span-6 md:mt-0">
                    <div class="lg:ml-5">
                        <div
                            class="p-6 bg-white rounded-md shadow dark:bg-slate-900 dark:shadow-gray-800">
                                        ...
                                        <div class="text-left">
                                            ...
                                            <div
                                                ...
                                                <textarea name="comments" id="comments"
                                                    class="form-input pl-11 h-28" placeholder="Message :"></textarea>
                                            </div>
                                        </div>
                                    </div>
                                </div>
